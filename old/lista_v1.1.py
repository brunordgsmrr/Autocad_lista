...
def Limpa_lista():
    ...
    for item in lista_original:
        ...
        if item[13:18] == 'PARAF' or item[13:18] == 'PORCA' or item[13:18] == 'A. LI' or item[13:18] == 'T PER' or item[13:18] == 'CONTR':
            continue
    ...
    for item in nova_lista:
        ...
        novo_item = 'POS.' + ''.join([pos,quantidade,descricao,cont_descricao,material])
